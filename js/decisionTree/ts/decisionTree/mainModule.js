...
import { maxDepthInput, minKnowledgeInput, newCSVFilename, builtInCSVFilename, ClassifyBtn, CreateTreeBtn, percentToClassify, resetTreeTransformation, BuiltInCSV, createTreeMethod } from "./bindings.js";
...
CreateTreeBtn.addEventListener("click", async () => {
    ...
    tree.freeVisuals();
    tree = new DecisionTree(await loadCSV((createTreeMethod == BuiltInCSV ? builtInCSVFilename : newCSVFilename)), maxDepthInput, minKnowledgeInput);
});
